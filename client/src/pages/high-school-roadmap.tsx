...
export default function HighSchoolRoadmap() {
  const { data: roadmap, isLoading, error } = useQuery({
    queryKey: ["/api/roadmap", "high_school"],
    queryFn: async () => {
      const response = await fetch("/api/roadmap/high_school");
            ...
            <div className="mt-8 pt-6 border-t">
              <div className="grid md:grid-cols-2 gap-4">
                <Link href="/high-school">
                  ...
                  >
                    <div className="text-left">
                      <div className="font-semibold">예고 입시정보</div>
                ...
                <Link href="/middle-school-roadmap">
                  ...
                  >
                    <div className="text-left">
                      <div className="font-semibold">예중 입시로드맵</div>
                      <div className="text-sm text-gray-600">예중 입시 준비 가이드</div>
                    </div>
                  </Button>
                </Link>
              </div>
